...
while True:
    try:
        ...
        #Droplink.co Req1
        drop_req1 = requests.get("https://droplink.co/Zagl")
        ...
        drop_data = 'clikarlink=Zagl&yuidea=&verify=Click+here+to+continue'
        ...
        drop_req4 = requests.get('https://droplink.co/Zagl', headers=drop_headers, cookies=drop_main_cook)
        ...
        #Droplink
        drop_main_cook['ab'] = '2'
        drop_headers = {'Host': 'droplink.co', 'User-Agent': useragent, 'Accept-Encoding': 'gzip, deflate','Content-Type': 'application/x-www-form-urlencoded; charset=UTF-8', 'X-Requested-With': 'XMLHttpRequest','Origin': 'https://droplink.co', 'Referer': 'https://droplink.co/Zagl', 'Sec-Fetch-Mode': 'cors','Sec-Fetch-Site': 'same-origin'}
